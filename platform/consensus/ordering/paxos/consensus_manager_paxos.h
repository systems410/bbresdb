...
#include "platform/consensus/ordering/paxos/performance_manager.h"
#include "platform/consensus/ordering/paxos/query.h"
#include "platform/consensus/ordering/paxos/response_manager.h"
...
class ConsensusManagerPaxos : public ConsensusManager {
 public:
  ...
  ConsensusManagerPaxos(const ResDBConfig& config,
  ...
  virtual ~ConsensusManagerPaxos() = default;
